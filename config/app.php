...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'Εφαρμογή Αξιολόγησης Γνώσεων'),
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Public deployments can expose the canonical source code URL so hosted
    | users can easily locate the corresponding source for the running build.
    |
    */
    ...
    */
    ...
    'version' => env(
        'APP_VERSION',
        (is_file(base_path('VERSION')) ? trim((string) file_get_contents(base_path('VERSION'))) : '') ?: 'dev'
    ),
