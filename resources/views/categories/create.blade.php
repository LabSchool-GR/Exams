        ...
        <section class="dashboard-section-card dashboard-section-card--form" style="max-width: 42rem;">
            <div class="dashboard-page-header">
                <div>
                    ...
                    <h1 class="dashboard-page-header__title">{{ __('quizzes_cards.create_category') }}</h1>
                    <p class="dashboard-page-header__subtitle mw-100">{{ __('quizzes.category_create_text') }}</p>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('categories.store') }}" class="dashboard-form-grid">
                @csrf
                ...
                <div class="dashboard-form-field dashboard-form-field--full">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" required class="dashboard-input" placeholder="{{ __('quizzes_cards.example_math') }}">
                </div>
