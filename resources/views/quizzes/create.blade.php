                ...
                <form action="{{ route('quizzes.store') }}" method="POST" enctype="multipart/form-data" class="dashboard-form-stack">
                    ...
                    <div class="dashboard-form-panel">
                        ...
                        <div class="dashboard-form-group mt-3">
                            ...
                            <input type="number" name="anonymous_pool_capacity" id="anonymous_pool_capacity" min="1" max="{{ $participantLimit ?? 9999 }}" value="{{ old('anonymous_pool_capacity', $defaultAnonymousPoolCapacity) }}" class="form-control dashboard-form-control @error('anonymous_pool_capacity') is-invalid @enderror">
