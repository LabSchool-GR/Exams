...
return [
    ...
    'exam_slot_name' => 'Exam Slot :code',
    'anonymous_slots_created' => 'Created :count pre-registered exam slots successfully.',
    'anonymous_slots_unavailable' => 'There are not enough available unique 4-digit codes to create the requested exam slots.',
    'anonymous_bulk_mode_manual_disabled' => 'This quiz uses bulk examination with pre-registered slots. Generate exam slots instead of registering named participants.',
    'anonymous_bulk_mode_disabled' => 'Bulk examination with pre-registered slots is not enabled for this quiz.',
    ...
    'public_anonymous_pool_mode_disabled' => 'The invitation PDF is available only for quizzes using Public Anonymous Pool mode.',
    'public_anonymous_pool_invitation_inactive' => 'Activate the quiz before creating a participation invitation.',
    'public_anonymous_pool_invitation_expired' => 'This invitation public link has expired. Refresh the page and create a new PDF.',
    'public_anonymous_pool_link_unavailable' => 'The public participation link could not be generated.',
    'special_modes_conflict' => 'Choose either Bulk Exam with Pre-registered Slots or Public Anonymous Pool mode, not both at the same time.',
    'learning_mode_special_modes_conflict' => 'Learning mode cannot be combined with Bulk Exam with Pre-registered Slots or Public Anonymous Pool mode.',
    'anonymous_pool_capacity_limit' => 'Capacity cannot exceed your account limit of :max participants per quiz.',
    'participation_mode_has_students' => 'The bulk participation mode cannot be changed while registered slots or participants exist. Remove those records first.',
    'second_screen_conflict' => 'TV + Mobile Controller mode cannot be combined with Learning mode, Bulk Exam with Pre-registered Slots, or Public Anonymous Pool mode.',
    ...
    'question_csv_empty' => 'The uploaded question CSV is empty.',
    'question_csv_read_failed' => 'The question CSV could not be read.',
    'question_csv_utf8_required' => 'The question CSV must use UTF-8 encoding.',
    'question_csv_row_utf8_required' => 'CSV record :row contains text that is not valid UTF-8.',
    'question_csv_invalid_headers' => 'The CSV must contain the headers: text, answer_1, answer_2, ..., correct_answers.',
    'question_csv_too_many_rows' => 'The CSV may contain up to :max questions.',
    'question_csv_too_many_answer_columns' => 'The CSV may contain up to :max answer columns.',
    'question_csv_text_required' => 'CSV record :row: question text is required.',
    'question_csv_minimum_answers' => 'CSV record :row: each question must include at least two answers.',
    'question_csv_answer_limit' => 'CSV record :row: you may import up to :max answers for this question.',
    'question_csv_correct_required' => 'CSV record :row: correct_answers is required.',
    'question_csv_correct_format' => 'CSV record :row: correct_answers must contain answer numbers such as 1 or 1,3.',
    'question_csv_correct_duplicates' => 'CSV record :row: correct_answers cannot contain duplicate answer numbers.',
    'question_csv_correct_missing' => 'CSV record :row: correct_answers refers to an answer that is missing.',
    'question_csv_no_valid_rows' => 'The CSV does not contain any question records.',
    'question_csv_imported' => '{1} One question was imported successfully.|[2,*] :count questions were imported successfully.',
